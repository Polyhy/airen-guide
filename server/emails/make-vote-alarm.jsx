...
MakeVoteAlarm = React.createClass({
	propTypes: {
					...
					<tr>
						<td style={{borderLeft:"1px solid #d5d5d5",borderRight:"1px solid #d5d5d5"}}>
							<table align="center" border="0" width="628" cellPadding="0" cellSpacing="2"
								...
								<tr height="60px">
									<td width="60px"></td>
									<td width="510px;"><p><b style={{color:"#545454"}}>{emailForm.userName}</b>님, 투표가 시작되었습니다</p>
										<hr/>
									</td>
									<td width="60px;"></td>
								</tr>
								<tr>
									<td width="60px;"></td>
									<td width="510px;">
										<p>회원님이 소속되어있는 {emailForm.teamName}팀에서 새로운 투표가 시작되었습니다.</p>
										<p>아래의 링크를 클릭해 투표를 진행 해 주세요</p>
										<br/>
										<p><a href={emailForm.url}>{emailForm.url}</a></p>
									</td>
									<td width="60px;"></td>
								</tr>
								</tbody>
